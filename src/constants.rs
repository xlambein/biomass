...
pub const ASTEROID_DISTANCE: Range<f32> =
	(SCREEN_WIDTH / VIEWPORT_SCALE / 2.)..(SCREEN_WIDTH / VIEWPORT_SCALE / 2. + 100.);
pub const ASTEROID_INIT_VELOCITY_RADIAL: Range<f32> = 50.0..200.0;
pub const ASTEROID_INIT_VELOCITY_NORMAL: Range<f32> = -50.0..50.0;
pub const ASTEROID_DESPAWN_DISTANCE: f32 = SCREEN_WIDTH / VIEWPORT_SCALE;
